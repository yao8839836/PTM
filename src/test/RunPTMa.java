...
public class RunPTMa {
	...
	public static void main(String[] args) throws IOException {
		...
		for (int iter = 0; iter < 10; iter++) {
			...
			PTMa ptm = new PTMa(herbs, symptoms, herbs_list.size(), symptoms_list.size());
			...
			String filename = "result//topic_ptm_a_" + K + ".txt";
			...
			filename = "result//topic_ptm_a_" + K + "_role.txt";
			ReadWriteFile.writeFile(filename, sb.toString());

		}

		ReadWriteFile.writeFile("file///ptm_a_" + K + "_topic.csv", sb_str.toString());
