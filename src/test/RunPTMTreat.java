...
public class RunPTMTreat {
	...
	public static void main(String[] args) throws IOException {
		...
		PTMTreat linklda = new PTMTreat(herbs, symptoms, herbs_list.size(), symptoms_list.size(), herb_symptom_links);
		...
		linklda.markovChain(K, alpha, beta, beta_bar, eta, alpha_t, iterations);
		...
		String filename = "result//topic_ptm_3d(c)_25.txt";
