...
public class RunBlockLDA {
	...
	public static void main(String[] args) throws IOException {
		...
		for (int iter = 0; iter < 10; iter++) {
			...
			BlockLDA linklda = new BlockLDA(herbs, symptoms, herbs_list.size(), symptoms_list.size(), links);
			...
			linklda.markovChain(K, alpha, beta, beta_bar, alpha_l, iterations);
			...
			String filename = "result//blocklda_topic_" + K + ".txt";
		...
		ReadWriteFile.writeFile("file///blocklda_" + K + "_topic.csv", sb_str.toString());
