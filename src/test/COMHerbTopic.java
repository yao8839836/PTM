...
public class COMHerbTopic {
	...
	public static void main(String[] args) throws IOException {
		...
		for (int iter = 0; iter < 10; iter++) {
			...
			double[][] phi_for_write = Common.makeCopy(phi_zi);

			double[][] phi_bar_for_write = Common.makeCopy(phi_zu);
			...
			String filename = "result//topic_com_" + K + ".txt";
		...
		ReadWriteFile.writeFile("file///com_" + K + "_topic.csv", sb_str.toString());
