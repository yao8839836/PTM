...
public class RunPTMd {
	...
	public static void main(String[] args) throws IOException {
		...
		for (int iter = 0; iter < 10; iter++) {
			...
			PTMd ptm = new PTMd(herbs, symptoms, herbs_list.size(), symptoms_list.size(), herb_symptom);
			...
			String filename = "result//topic_ptm_d_" + K + ".txt";
			...
			filename = "result//topic_ptm_d_" + K + "_role.txt";
			ReadWriteFile.writeFile(filename, sb.toString());

		}
		ReadWriteFile.writeFile("file///ptm_d_" + K + "_topic.csv", sb_str.toString());
