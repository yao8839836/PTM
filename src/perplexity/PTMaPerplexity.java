...
public class PTMaPerplexity {
	...
	public static void main(String[] args) throws IOException, ClassNotFoundException {
		...
		for (int i = 0; i < 10; i++) {
			...
			PTMa ptm = new PTMa(herbs_train_new, symptoms_train_new, herbs_list.size(), symptoms_list.size());
			...
			System.out.println("PTM(a) perplexity : " + perplexity);
		...
		ReadWriteFile.writeFile("file//PTMa_Perplexity_" + K + ".csv", sb.toString());
