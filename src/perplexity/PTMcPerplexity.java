...
public class PTMcPerplexity {
	...
	public static void main(String[] args) throws IOException, ClassNotFoundException {
		...
		for (int i = 0; i < 10; i++) {
			...
			PTMc ptm = new PTMc(herbs_train_new, symptoms_train_new, herbs_list.size(), symptoms_list.size(),
					herb_symptom);
		...
		ReadWriteFile.writeFile("file//PTMc_Perplexity_" + K + ".csv", sb.toString());
