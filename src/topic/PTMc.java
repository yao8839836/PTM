...
public class PTMc {
	...
	public PTMc(int[][] herbs, int[][] symptoms, int H, int S, Map<Integer, Set<Integer>> herb_symptom) {
	...
	public void gibbs() {
		...
		for (int p = 0; p < herbs.length; p++) {
			...
			for (int n = 0; n < herbs[p].length; n++) {
				...
				if (herb_symptom.containsKey(herbs[p][n])) {

					Set<Integer> corr_symptoms = herb_symptom.get(herbs[p][n]);
