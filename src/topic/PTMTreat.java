...
public class PTMTreat {
	...
	public PTMTreat(int[][] herbs, int[][] symptoms, int H, int S, int[][] treat_links) {
	...
	public void markovChain(int K, double alpha, double beta, double beta_bar, double eta, double alpha_t,
			int iterations) {
